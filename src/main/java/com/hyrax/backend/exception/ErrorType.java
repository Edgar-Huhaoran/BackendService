...
public enum ErrorType {
    ...
    UPLOAD_ICON_FAILED(HttpStatus.BAD_REQUEST, 40013, "upload user icon failed", "用户头像上传失败"),
    ...
    RESOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, 4041, "resource do not find", "找不到资源"),
